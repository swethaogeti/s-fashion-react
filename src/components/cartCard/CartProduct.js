...
const CartProduct = ({
  ...
  return (
    <div className="cart-product">
      <div className="hoz-card-container">
        ...
        <div className="description-container">
          ...
          <div className="icon-btn">
            <button
              onClick={() => {
                cartDispatch({ type: "DECREASE", item: id });
              }}
            >
            ...
            <button
              onClick={() => {
                cartDispatch({ type: "INCREASE", item: id });
              }}
            >
              <i className="fa fa-plus"></i>
            </button>
          </div>
          <div className="hoz-card-btn">
            <button
              className="btn btn-primary"
              onClick={() => {
                cartDispatch({ type: "REMOVE_FROM_CART", item: id });
              }}
            >
              DELETE
            </button>
            ...
            {wishlist.some((i) => i.id === id) ? (
              ...
              <button
                className="btn o-btn-primary btn"
                onClick={() => {
                  cartDispatch({
