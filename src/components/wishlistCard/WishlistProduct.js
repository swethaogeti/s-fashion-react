...
const WishlistProduct = ({image,brand,id,title,price,discount,total_price}) => {
 ...
 :(<div className='badge text-badge icon-badge'><i className='fas fa-shopping-cart' onClick={()=>{cartDispatch({type:'ADD_TO_CART',item:{image,brand,title,id,price,discount,total_price,amount:1}}) }} ></i></div>)}
